...
/// <summary>Deterministic in-memory file system. Paths use forward slashes.
/// Implements both <see cref="IFileSystem"/> and <see cref="IFileWriter"/> so a single instance
/// can serve as both seams in <see cref="ClaudeExplorer.Core.Mutation.SafeMutationService"/>.</summary>
